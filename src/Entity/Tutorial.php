...
class Tutorial
{
    ...
    #[Assert\Length(max: 255, maxMessage: 'Le tutoriel saisie {{ value }} est trop longue, elle ne devrait pas dépasser {{ limit }} caractères',)]
    ...
    public function removeLesson(Lesson $lesson): self
    {
        if ($this->lessons->removeElement($lesson)) {
            ...
            if ($lesson->getTutorial() === $this) {
                $lesson->setTutorial(null);
            }
        }
